...
from vnpy.app.spread_trading.base import EVENT_SPREAD_LOG
...
if argv[1] == 'test':
    ...
    raise Exception('can not identify environment')
with open(ctp_setting_path, 'r', encoding='utf8')as fp:
    ctp_setting = json.load(fp)
